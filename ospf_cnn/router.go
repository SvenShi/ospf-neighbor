...
func NewRouter(ifName string, addr *net.IPNet, rtid string) (*Router, error) {
...
func (r *Router) AnnounceASBRRoute(ips []net.IPNet) {
	r.ins.addASBRLSA(ips...)
}

func (r *Router) RevokeASBRRoute(ips []net.IPNet) {
	r.ins.delASBRLSA(ips...)
}
